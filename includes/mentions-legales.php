    ...
    <div class="xLarge-12 large-12 medium-12 small-12 xSmall-12">
        <div class="padd-around">
            <div class="column fullText">
                ...
                <p class="title">Services fournis :</p>
                ...
                <p class="title">Limitation contractuelles sur les données :</p>
                ...
                <p class="title">Propriété intellectuelle :</p>
                ...
                <p class="title">Déclaration à la CNIL :</p>
